...
{
  static TypeId tid = TypeId ("ns3::weep::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::weep::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("AodvWeep")
...
{
  static TypeId tid = TypeId ("ns3::weep::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("AodvWeep")
...
{
  static TypeId tid = TypeId ("ns3::weep::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("AodvWeep")
...
{
  static TypeId tid = TypeId ("ns3::weep::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("AodvWeep")
