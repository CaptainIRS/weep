...
#ifndef AODV_WEEP_PACKET_H
#define AODV_WEEP_PACKET_H
...
enum MessageType
{
  AODV_WEEP_TYPE_RREQ  = 1,   //!< AODV_WEEP_TYPE_RREQ
  AODV_WEEP_TYPE_RREP  = 2,   //!< AODV_WEEP_TYPE_RREP
  AODV_WEEP_TYPE_RERR  = 3,   //!< AODV_WEEP_TYPE_RERR
  AODV_WEEP_TYPE_RREP_ACK = 4 //!< AODV_WEEP_TYPE_RREP_ACK
};
...
public:
   ...
   */
  TypeHeader (MessageType t = AODV_WEEP_TYPE_RREQ);
